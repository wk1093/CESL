...
#include <GL/glu.h>
    ...
    !defined(__gl2_h_) && !defined(__gl3_h_) && !defined(__gl31_h_) &&         \
    !defined(__gl32_h_) && !defined(__glcorearb_h_) && !defined(__GL_H__) &&   \
    !defined(__gltypes_h_) && !defined(__glee_h_)
#if defined(__APPLE__)
...
struct WindowSettings {
    ...
    bool __settingsSpecified;
};

struct WindowSettings defaultWindowSettings() {
    ...
    settings.__settingsSpecified = true;
    return settings;
}
...
struct Window *newWindow(char *title, int width, int height,
                         struct WindowSettings settings) {
    ...
    if (!settings.__settingsSpecified) {
...
bool updateWindow(struct Window *win) {
