...
struct StringArray *split_c(const char *stri, char delim) { // split by char
...
struct StringArray *split_cs(const char *stri,
                             const char *delims) { // split by chars
    struct StringArray *sa = newStringArray();
    char *str = (char *)malloc(sizeof(char *) * strlen(stri));
    strcpy(str, stri);
...
struct StringArray *split_s(const char *stri,
                            const char *delim) { // split by string
    if (strlen(delim) == 1) {
...
struct StringArray *split_ss(const char *stri,
                             struct StringArray *delims) { // split by strings
...
char *replace_c2c(const char *stri, char from,
                  char to) { // replace char with char
    char *str = (char *)malloc(sizeof(char *) * strlen(stri));
    strcpy(str, stri);
...
char *replace_cs2c(const char *stri, const char *from,
                   char to) { // replace chars with char
    char *str = (char *)malloc(sizeof(char *) * strlen(stri));
    strcpy(str, stri);
    for (int i = 0; i < strlen(str); i++) {
...
char *replace_c2s(const char *stri, char from,
                  const char *to) { // replace char with string
...
char *replace_cs2s(const char *stri, const char *from,
                   const char *to) { // replace chars with string
    struct CharArray *ca = newCharArray();
...
char *replace_s2s(const char *stri, const char *from,
                  const char *to) { // replace string with string
    struct CharArray *ca = newCharArray();
